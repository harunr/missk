...
;(function($){
	$(function(){
        ...
        $(".main-menu ul li").find("ul").parent().addClass("hasSubnav")
        if( $(window).width() < 768 ){
            $(".main-menu > ul > li.hasSubnav > a").click(function(e){
                e.preventDefault()
                
                $(".main-menu > ul > li.hasSubnav > ul").slideUp()
        ...
        if( $(".bg-color").length ){
            $("body").addClass("different-color")
        }
        
        
        $(".link a").mouseenter(function(){
            $(this).parents(".link-item").addClass("hovered")
        })
        
        $(".link a").mouseleave(function(){
            $(this).parents(".link-item").removeClass("hovered")
        })
	...
	$(window).load(function(){
        // Begin common slider
        if ( $('.testimonial-slider').length == 0 ) return false
